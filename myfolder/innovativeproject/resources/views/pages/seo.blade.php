...
<html lang="en">
       ...
       <!--================Offcanvas Menu Area =================-->
          <div class="offcanvas_menu right_direction">
                ...
                <ul class="nav">
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                                ...
                                <li class="active"><a href="seo.html">SEO</a></li>
                        </ul>
                    </li>
                    <li class="submenu">
                        <a href="#">Blog</a>
            ...
            <div class="copy_right_menu">
                <p>© <a href="#">Innovative V</a> <script>document.write(new Date().getFullYear());</script>. All Rights Reserved . Design by <a href="https://www.innovativev.co.uk">www.Innovativev.co.uk</a> </p>
            </div>
        </div>
        ...
        <section class="single_img_area">
            <div class="container">
                <div  class="kl_single_content">
                    <h5>We have anything you want</h5>
                    <h2>Amazing Business Ideas</h2>
                    <p>Maecenas sed diam eget risus varius blandit sit amet non magna. Nullam quis risus eget urna mollis ornare vel eu leo. Integer posuere erat a ante venenatis dapibus posuere velit aliquet.</p>
 ...
 <section class="who_we_area">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="who_text">
                            ...
                            <p>Making compelling copies that convert viewers into customers is what our creative copywriters do best. Great content indulges users but a great copy converts users into customers. Our team of creative copywriters are trained professionals who understand your need from a copy. From advertisements to company brochures, we write amazing and compelling copies that produce results and boost ROI. Talk to us today and tell us about your copywriting needs.</p>
                            <p>
                                <ul>
                                    <li><i style="color: #1a1a26;" class="fa fa-check-circle" aria-hidden="true">&nbsp</i>Advertisement Copywriting</li>
                                    <li><i style="color: #1a1a26;" class="fa fa-check-circle" aria-hidden="true">&nbsp</i>Digital Marketing Copywriting</li>
                                    <li><i style="color: #1a1a26;" class="fa fa-check-circle" aria-hidden="true">&nbsp</i>Digital Advertisement Copywriting</li>
                                    <li><i style="color: #1a1a26;" class="fa fa-check-circle" aria-hidden="true">&nbsp</i>Keyword Based Copywriting</li>
                                    <li><i style="color: #1a1a26;" class="fa fa-check-circle" aria-hidden="true">&nbsp</i>Sales Pitch & Related Copywriting</li>
                                </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        for Success to Guarantee Results for Our Clients</h2>
                    <p>Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Vestibulum id ligula porta felis euismod semper</p>
                </div>
        ...
        <section class="kl_funfact_area">
            <div class="container-fluid">
                <div class="row">
                    <div class="funfact_item">
                        <img src="img/fun-fact/fan_fact1.jpg" alt="">
                    ...
                    <div class="funfact_item">
                        <img src="img/fun-fact/fan_fact5.jpg" alt="">
                        <div class="fact_content">
                            <h3 class="counter">305</h3>
                            <h2>Cases completed</h2>
                            <img src="img/icon/sound.png" alt="">
                        </div>
                    </div>
                    <div class="funfact_item">
                        <img src="img/fun-fact/fan_fact2.jpg" alt="">
                        <div class="fact_content">
                            <h3 class="counter">32</h3>
                            <h2>Professional Advisors</h2>
                            <img src="img/icon/user-of.png" alt="">
                        </div>
                    </div>
                    <div class="funfact_item">
                        <img src="img/fun-fact/fan_fact3.jpg" alt="">
                        <div class="fact_content">
                            <h3 class="counter">99</h3>
                            <h2>New Cases Every Years</h2>
                            <img src="img/icon/meeter.png" alt="">
                        </div>
                    </div>
                    <div class="funfact_item">
                        <img src="img/fun-fact/fan_fact4.jpg" alt="">
                        <div class="fact_content">
       ...
       <section class="recent_work_area">
            <div class="container">
                    ...
                    <div class="col-sm-4">
                        <div class="pricing_box">
                            <div class="pricing-header">
                                ...
                                <h2>Basic</h2>
                                <h3 class="packeg_typ">$29<small>/month</small></h3>
                            </div>
                            <p>It is a long established fact that a reader will be distracted by the  when at its layout letters.</p>
                            <ul class="plan-lists">
                                <li><i class="fa fa-check" aria-hidden="true"></i>22 PSD files include</li>
                                <li><i class="fa fa-check" aria-hidden="true"></i>Multipurpose Wordpress</li>
                                <li><i class="fa fa-check" aria-hidden="true"></i>Clean & Unique Design</li>
                                <li><i class="fa fa-check" aria-hidden="true"></i>Woocomerce Plugin</li>
                            </ul>
                            <a href="#" class="btn c_btn pricing_btn">Order Service</a>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="pricing_box">
                            <div class="pricing-header">
                                ...
                                <h2>professional</h2>
                                <h3 class="packeg_typ">$39<small>/month</small></h3>
                            </div>
                            <p>It is a long established fact that a reader will be distracted by the  when at its layout letters.</p>
                    ...
                    <div class="col-sm-4">
                        <div class="pricing_box">
                            <div class="pricing-header">
                                ...
                                <h2>Basic</h2>
                                <h3 class="packeg_typ">$49<small>/month</small></h3>
                            </div>
                            <p>It is a long established fact that a reader will be distracted by the  when at its layout letters.</p>
                            <ul class="list-unstyled plan-lists">
                                <li><i class="fa fa-check" aria-hidden="true"></i>22 PSD files include</li>
                ...
                <form class="req_contact_inner" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                    ...
                    <div class="form-group">
                        <select class="selectpicker">
                            ...
                            <option>I would like to describe</option>
                            <option>I would like to discuss</option>
                        </select>
                    </div>
                    <div class="form-group">
