            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="pro-add-form" action="edit_processing.php" method="POST" enctype="multipart/form-data">
                                    <?php 
                                    $editid = $_GET['id'];
                                    $query = "SELECT * FROM themes where id='$editid'";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" id="pname" placeholder="Enter Title" value="<?php echo $title;?>" /> </div>
                                    <div class="form-group">
                                    <div class="row">
                                         <div class="col-sm-6">
                                            <label for="city">Category</label>
                                                ...
                                                else
                                                {
                                                    while($row = $result->fetch_assoc())
                                                    {
                                                        ...
                                                        {
                                                        ?>
                                                        <option value="<?php echo $nid;?>" selected><?php echo $name;?></option>
                                                        <?php
                                                        }
                                                        else
                                                        {
                                        ...
                                        <div class="col-sm-6">
                                            <label for="city">Language</label>
                                                <select name="language" class="form-control custom-select" id="Language" />
                                                <?php
                                                $query_lang = "SELECT * FROM languages order by id desc";
                                                $result_lang = $connect->query($query_lang);
                                                if(!$result_lang)
                                                {
                                                    echo $connect->error;
                                                }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" rows="5" id="pdesc" placeholder="Enter Description"/><?php echo $description;?></textarea>
                                    </div>
                            
                             
                                    <div class="form-group">
                                        <img style=" width: 100px; height: 100px;" src="themes/<?php echo $image;?>" alt="">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="link" name="link" value="<?php echo $link;?>" class="form-control" >
                                    </div>
                                   
                                    <button type="submit" name="Add-theme"  class="btn btn-success waves-effect waves-light  m-r-10">Add Theme</button>
