    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div  class="col-sm-6">
                        <h2 style="color: black;">Language</h2>
                    </div>
                    <div class="col-sm-6">
                        <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"> <span>Add Language</span></a>                        
                    </div>
                </div>
            </div>
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr>
                        <?php
                            $query_display = "SELECT * FROM languages Order by id desc ";
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="modal-body">                    
                    <div class="form-group">
                        ...
                        <input type="text" name="lang" value="<?php echo $name;?>" class="form-control" />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">                    
                    <div class="form-group">
                        <label>Language</label>
                        <input type="text" name="lang" class="form-control"  class="required" />
...
if(isset($_POST['add']))
{
    ...
    $query = "INSERT INTO `languages`(`name`) VALUES ('$lang_name')";
    ...
    {
        header('location:themelanguages.php');
    }
}
if(isset($_POST['edit']))
{
    $id = $_POST['id'];
    $lang_name = $_POST['lang'];
    $query = "UPDATE languages SET name='$lang_name' where id='$id'";
    $res = $connect->query($query);
    if(!$res)
    {
        echo $connect->error;
