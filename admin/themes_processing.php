...
<body class="skin-blue fixed-layout">
    ...
    <!-- ============================================================== -->
    <div id="overlay"><p align="center" class="text"><i style="font-size:30px;" class="fa fa-check"></i><br>Theme Added Successfully!<br> You will be redirected in 5 seconds</p></div>
...
$query = "INSERT INTO `themes`(`title`, `description`, `image`, `link`, `category_id`,`language`) VALUES ('$title','$description','$name','$link','$category','$language')";
