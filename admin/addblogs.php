            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="pro-add-form" action="add-blog-processing.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="pname">Blog Title</label>
                                        <input type="text" name="title" class="form-control" id="pname" placeholder="Enter Title" required/> </div>
                                    <div class="form-group">
                                    <div class="row">
                                         <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="sdescription" rows="5" id="pdesc" placeholder="Enter Description"/></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="image1" id="input-file-now" class="dropify" required/>
                                    </div>
                                    <div class="form-group">
                                        <label for="pdesc">Long Description</label>
                                        <textarea class="form-control" name="ldescription" rows="5" id="pdesc" placeholder="Enter Description"/></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="input-file-now">Upload Images</label>
                                    ...
                                    <div class="form-group">
                                        <label for="pdesc">Long Description</label>
                                        <textarea class="form-control" name="ldescription2" rows="5" id="pdesc" placeholder="Enter Description"/></textarea>
                                    </div>
                                   
                                   
                                    <button type="submit" name="Add-Blog"  class="btn btn-success waves-effect waves-light  m-r-10">Add Blog</button>
