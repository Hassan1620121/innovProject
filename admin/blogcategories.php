    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div  class="col-sm-6">
                        <h2 style="color: black;">Blog Categories</h2>
                    </div>
                    <div class="col-sm-6">
                        <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"> <span>Add Blog Categories</span></a>                        
                    </div>
                </div>
            </div>
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr>
                        <?php
                            $query_display = "SELECT * FROM blogcategories Order by id desc ";
...
if(isset($_POST['add']))
{
    ...
    $query = "INSERT INTO `blogcategories`(`Name`) VALUES ('$cat_name')";
...
if(isset($_POST['edit']))
{
    $id = $_POST['id'];
    $cat_name = $_POST['category'];
    $query = "UPDATE blogcategories SET Name='$cat_name' where id='$id'";
    $res = $connect->query($query);
    if(!$res)
    {
        echo $connect->error;
